                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted">{{ $supplier->obat()->count() }} obat tersedia</small>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <span class="text-muted">{{ $supplier->kota }}</span>
                            </td>
                            <td>
                                <span class="text-muted">{{ $supplier->telepon }}</span>
                            </td>
                            <td>
                                <div class="fw-bold">{{ $supplier->created_at ? $supplier->created_at->format('d/m/Y') : '-' }}</div>
                                <small class="text-muted">{{ $supplier->created_at ? $supplier->created_at->format('H:i') : '-' }}</small>
                            </td>
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <a href="{{ route('admin.supplier.show', $supplier->id_supplier) }}" 
...
$(document).ready(function() {
    try {
        ...
        $('#supplierTable').addClass('table-striped');
    }
});
</script>
@endpush